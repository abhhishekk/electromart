...
<div class="jumbotron">
	<h1>Add Your Brand Details,<br> Welcome to <span style="color:green;">Electromart</span></h1>
	<p class="pt-3" style="font-size: 21px;">Create an Account and add your Products</p>
</div>
   	  ...
   	  <form method="POST" action="inc/msignup.inc.php" class="pb-5">
      	...
      	<div class="form-group">
      	 <label>Brand Name</label>
      		<input type="text" name="bname"  placeholder="Your Brand Name" class="form-control">
      	</div>
      	<div class="form-group">
