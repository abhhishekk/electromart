      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <?php
            ...
            $avatar = "select profile from customers where username = '$name';";
...
<table class="table table-responsive-md table-striped justify-content-center mb-5">
   ...
   ?>
      ...
      <td><img src="uploads/<?php echo $value['item_img']; ?>" height='50px'></td>
			...
			<td>&#8377; <?php echo number_format($value['item_qty'] * $value['item_pprice'], 2); ?></td>
			<td><a class="btn btn-danger btn-sm" href="inc/deletecart.inc.php?cart=delete&id=<?php echo $value['item_pid']; ?>"><i class="fa fa-trash-alt"></i> Remove</a></td>
		</tr>

     <?php
          $total = $total + ($value['item_qty'] * $value['item_pprice']);
      }
     ?>
     ...
     <tr>
       <td><a href="products.php" class="btn btn-primary btn-sm"><i class="fa fa-cart-plus"></i> Add More</a></td>
       <td></td>
       <td></td>
       <td></td>
       <td></td>
