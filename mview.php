 ...
 ?>
  ...
  <div class="container">
   	<div class="row">
   	  <div class="col-md-4 pb-5">
            <div class="mylist list-group">
              ...
              <a href="mview.php" class="list-group-item active">View Products</a>
       ...
       <div class="col-md-8 pt-1 pb-3">
           <legend class="text-center" style="border:1px solid black; width: 100%; margin: 0 auto;">YOUR PRODUCTS LIST
            ...
            <table class="table table-responsive-md mytbl text-center">
                ...
                <th>Description</th>
                 ...
                 $sql = "select pid, pname, pprice, pdescription, pbrands from products where manager = '$manager';";
