...
<?php
  if (isset($_GET['submit'])) {
    ...
    if ($resultcheck > 0) {
      ...
      $sqls = "SELECT * FROM customers WHERE username = '$user';";
      ...
      $insert = "INSERT INTO delivery SET orderid='$orderid', ordereduser='$fullname', usercontact='$contact', useraddress='$address', payment_type='$payment_type', totalprice='$totalprice', res_status='shipped', delivery_status='delivering', delivery_person='$name';";
      mysqli_query($con, $insert);

      $update = "UPDATE orders SET res_status = 'shipped' WHERE orderid = '$orderid';";
 ...
 ?>
  ...
  <div class="container-fluid">
       ...
       <div class="col-md-4 pt-1 pb-3">
              <form method="GET">
                <legend style="border: 1px solid black; border-radius: 6px; color: black; font-size: 20px; font-weight: 500; margin: 0 auto; background-color: #FAFAFA;" class="pl-3 pr-3 pb-3">Sent the order to delivery personnel
              <br>
              <?php
              if (isset($_GET['name'])) {
                $uname = $_GET['name'];
              ...
              ?>
               ...
               ?> 
                <div class="form-group">
                  <label style="font-size: 15px;">Selected Delivery Personnels</label>
