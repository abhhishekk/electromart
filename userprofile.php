...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <?php
     ...
     $avatar = "select profile from customers where id = '$usersession';";
...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8 col-lg-8 col-sm-12">
     ...
     <?php
       $usersession = $_SESSION['u_id'];
       $check = "select  id, fullname, username, email, contactno, address, pwd, profile from customers where id = '$usersession';";
      ...
      ?>
      <form method="POST" class="bg-dark mb-5 p-3" action="inc/userprofile.inc.php" enctype="multipart/form-data">
