  ...
  <div class="container">
   	<div class="row">
   	  <div class="col-md-4 pb-3">
            <div class="mylist list-group">
              ...
              <a href="mdelete.php" class="list-group-item active">Delete Products</a>
       ...
       <div class="col-md-8 pt-1 pb-3">
        ...
        ?>
         ...
         <legend class="text-center" style="border:1px solid black; width: 100%; margin: 0 auto;">DELETE PRODUCTS
            ...
            <table class="table table-responsive-md mytbl text-center">
                ...
                <td><a class="btn btn-danger" href="inc/deleteproduct.inc.php?id=<?php echo $row['pid']; ?>" >Delete</a></td>
                </tr>
                 <?php } } ?>
                </tbody>
               </table> 
