...
<?php
//getting total cost of the product
 ...
 <div class="container">
  <?php
   if (isset($_GET['order'])) {
     ...
     if ($error == "error") {
       echo "<p class='alert alert-danger text-center'>Your Cash On Delivery Limit is High. Please Purchase Product Under 50000rs.</p>";
     }
   }
  ?>
  <br>
