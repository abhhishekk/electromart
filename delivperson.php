 ...
 ?>
  ...
  <div class="container-fluid">
       ...
       <div class="col-md-8 pt-1 pb-3">
           <legend class="text-center" style="border:1px solid black; width: 100%; margin: 0 auto;">Delivery Personnels (Online Here)
           <?php
           //getting delivery personnels that are online
            $sql = "SELECT * FROM delivperson WHERE dstatus='Ready';";
