...
<div class="jumbotron">
	<h1 style="font-size: 63px;">Hello Transporter <?php echo $_SESSION['u_name']; ?>!</h1>
 ...
 <div class="container">
    <div class="row pb-5">
      ...
      <div class="col-md-8 pt-1 pb-3">
         <legend class="text-center" style="border:1px solid black; width: 100%; margin: 0 auto;">Ready to transport?
          <?php
          //print_r($_SESSION);
           $dperson = $_SESSION['u_id'];
           $sql = "SELECT * FROM delivperson WHERE id='$dperson';";
          ...
          <table class="table table-responsive-md mytbl text-center">
                ...
                <td><a href="inc/dstatus.inc.php?id=<?php echo $dperson; ?>&status=Ready&currentstatus=<?php echo $row['status']; ?>&type=success" class="btn btn-success btn-sm">Ready</a> <a class="btn btn-danger btn-sm" href="inc/dstatus.inc.php?id=<?php echo $dperson; ?>&status=Not Ready&currentstatus=<?php echo $row['status']; ?>">Not Ready</a></td>
