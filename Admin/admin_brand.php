...
<head>
  ...
  <title>Electromart - Admin-Home</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Electromart Admin</div>
      </a>
      ...
      <!--Delivery Personnels-->
      <li class="nav-item">
        <a class="nav-link" href="admin_dperson.php">
          <i class="fas fa-user"></i>
          <span>Delivery Personnels</span></a>
      </li>
      <!--Delivery Personnels-->
             ...
             <thead>
              <tr><h5>Brand List</h5></tr>
               ...
               <tbody>
                ...
                <?php
                $sql = "select * from brands order by bid desc;";
                ...
                ?>
                 ...
                 <tr>
                   ...
                   <td><?php echo $row['bcontactno']; ?></td>
                   <td><a class="btn btn-success btn-sm m-1" href="includes/status.inc.php?bid=<?php echo $row['bid']; ?>">Enable</a><br> 
                   <a href="includes/statuss.inc.php?bid=<?php echo $row['bid']; ?>" class="btn btn-danger btn-sm">Disable</a></td>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy;  Electromart</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
