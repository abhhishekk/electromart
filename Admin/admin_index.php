...
<?php
 ...
 if ($resultcheck > 0) {
  ...
  $fire = "SELECT * FROM orders WHERE res_status = 'waiting';";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Hi <?php echo $_SESSION['ad_uname']; ?>, Welcome to Electromart</h1>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Brand Pending Requests</div>
